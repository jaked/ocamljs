...
%type <Stdlib_parsing_stuff.Parsetree.structure> implementation
%start interface                        /* for interface files */
%type <Stdlib_parsing_stuff.Parsetree.signature> interface
%start toplevel_phrase                  /* for interactive use */
%type <Stdlib_parsing_stuff.Parsetree.toplevel_phrase> toplevel_phrase
%start use_file                         /* for the #use directive */
%type <Stdlib_parsing_stuff.Parsetree.toplevel_phrase list> use_file
