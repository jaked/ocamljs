...
(* The jQuery Function *)
val jQuery : string -> jQuery
val jQuery_context : string -> Dom.element -> jQuery
val jQuery_jQuery : string -> jQuery -> jQuery
val jQuery_element : Dom.element -> jQuery
val jQuery_elements : Dom.element array -> jQuery

(* Shorthand for $(document).ready() *)
val jQuery_ready : ((string -> jQuery) -> unit) -> unit

(* Invoking Plugins *)
val jQuery_plugin : jQuery -> string -> 'a array -> unit
